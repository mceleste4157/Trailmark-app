...
7. Verify the navigation template, remaining distance, GPS updates, and off-route state.

## Known release blockers

- Native map tile renderer/offline map store is still separate from the browser service worker.
